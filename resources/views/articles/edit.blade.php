                ...
                <form action="{{ route('articles.update', $articles->id) }}" method="post"
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input value="{{ old('author', $articles->author) }}" name="author" placeholder="Penulis"
                                type="text" class="border-gray-300 shadow-sm w-full rounded-lg p-2">
                            @error('author')
                                <p class="text-red-400 font-medium">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <select id="status_publish" class="border-gray-300 shadow-sm w-full rounded-lg p-2">
                                ...
                                <option value="validasi"
                                    {{ old('status_publish', $articles->status_publish) == 'validasi' ? 'selected' : '' }}>
                                    Perlu Validasi
                                </option>
                                <option value="spesial" hidden
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea name="summary" id="summary" placeholder="Ringkasan/Summary"
                                class="border-gray-300 shadow-sm w-full rounded-lg p-2">{{ old('summary', $articles->summary) }}</textarea>
                            @error('summary')
                                <p class="text-red-400 font-medium">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea name="caption" id="caption" placeholder="Caption"
                                class="border-gray-300 shadow-sm w-full rounded-lg p-2">{{ old('caption', $articles->caption) }}</textarea>
                            @error('caption')
                                <p class="text-red-400 font-medium">{{ $message }}</p>
                            @enderror
                        </div>
