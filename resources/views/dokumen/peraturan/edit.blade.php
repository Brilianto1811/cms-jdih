                ...
                <form action="{{ route('peraturan.update', $peraturan->id) }}" method="post">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <input value="{{ old('tipe_dokumen', $peraturan->tipe_dokumen) }}" name="tipe_dokumen"
                        ...
                        <div>
                            ...
                            <input value="{{ old('judul', $peraturan->judul) }}" name="judul" placeholder="Judul"
                        ...
                        <div>
                            ...
                            <input value="{{ old('teu_badan', $peraturan->teu_badan) }}" name="teu_badan"
                        ...
                        <div>
                            ...
                            <input value="{{ old('no_peraturan', $peraturan->no_peraturan) }}" name="no_peraturan"
                        ...
                        <div>
                            ...
                            <input value="{{ old('tahun', $peraturan->tahun) }}" name="tahun" placeholder="Tahun"
                        ...
                        <div>
                            ...
                            <input value="{{ old('jenis', $peraturan->jenis) }}" name="jenis" placeholder="Jenis"
                                type="text" class="border-gray-300 shadow-sm w-full rounded-lg p-2">
                            @error('jenis')
                                <p class="text-red-400 font-medium">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input value="{{ old('singkatan_jenis', $peraturan->singkatan_jenis) }}"
                        ...
                        <div>
                            ...
                            <input value="{{ old('tempat_penetapan', $peraturan->tempat_penetapan) }}"
                                name="tempat_penetapan" placeholder="Tempat Penetapan" type="text"
                                class="border-gray-300 shadow-sm w-full rounded-lg p-2">
                        ...
                        <div>
                            ...
                            <input value="{{ old('tgl_penetapan', $peraturan->tgl_penetapan) }}" name="tgl_penetapan"
                        ...
                        <div>
                            ...
                            <input value="{{ old('sumber', $peraturan->sumber) }}" name="sumber" placeholder="Sumber"
                                type="text" class="border-gray-300 shadow-sm w-full rounded-lg p-2">
                            @error('sumber')
                                <p class="text-red-400 font-medium">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input value="{{ old('subjek', $peraturan->subjek) }}" name="subjek" placeholder="Subjek"
                                type="text" class="border-gray-300 shadow-sm w-full rounded-lg p-2">
                            @error('subjek')
                                <p class="text-red-400 font-medium">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <select name="status_peraturan" class="border-gray-300 shadow-sm w-full rounded-lg p-2">
                                <option value="Berlaku"
                                    {{ old('status_peraturan', $peraturan->status_peraturan) == 'Berlaku' ? 'selected' : '' }}>
                                    Berlaku
                                </option>
                                <option value="Tidak Berlaku"
                                    {{ old('status_peraturan', $peraturan->status_peraturan) == 'Tidak Berlaku' ? 'selected' : '' }}>
                                    Tidak Berlaku
                                </option>
                            </select>
                        ...
                        <div>
                            ...
                            <textarea name="keterangan_status" placeholder="Keterangan Status"
                                class="border-gray-300 shadow-sm w-full rounded-lg p-2">{{ old('keterangan_status', $peraturan->keterangan_status) }}</textarea>
                        ...
                        <div>
                            ...
                            <input value="{{ old('bahasa', $peraturan->bahasa) }}" name="bahasa"
                        ...
                        <div>
                            ...
                            <input value="{{ old('lokasi', $peraturan->lokasi) }}" name="lokasi"
                        ...
                        <div>
                            ...
                            <input value="{{ old('bidang_hukum', $peraturan->bidang_hukum) }}" name="bidang_hukum"
