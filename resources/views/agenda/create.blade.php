                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('agenda.store') }}" method="POST">
                        ...
                        <div class="flex justify-between items-center mb-4">
                            <label for="tgl_agenda" class="text-lg font-medium">Tanggal Agenda</label>
                            <input type="date" name="tgl_agenda" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                        </div>
                        <hr class="mb-5">
                        ...
                        <div id="kegiatan-container">
                            <div class="kegiatan-item mb-4">
                                <div class="flex justify-between items-center">
                                    ...
                                    <input type="time" name="agenda_kegiatan[0][waktu_kegiatan]"
                                        id="waktu_kegiatan_0" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                                </div>
                                <div class="flex justify-between items-center mt-2">
                                    <label for="judul_kegiatan_0" class="text-lg font-medium">Judul Kegiatan</label>
                                    <input type="text" name="agenda_kegiatan[0][judul_kegiatan]"
                                        id="judul_kegiatan_0" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                                </div>
                                <div class="flex justify-between items-center mt-2">
                                    <label for="deskripsi_kegiatan_0" class="text-lg font-medium">Deskripsi
                                        Kegiatan</label>
                                    <textarea name="agenda_kegiatan[0][deskripsi_kegiatan]" id="deskripsi_kegiatan_0"
                        ...
                        <button type="button" id="add-kegiatan"
                            class="bg-blue-500 text-white px-4 py-2 rounded-lg mb-4">Tambah Agenda</button>
            ...
            <hr class="my-4 border-gray-400">
                <div class="kegiatan-item mb-4">
                    <div class="flex justify-between items-center">
                        ...
                        <input type="time" name="agenda_kegiatan[${kegiatanCount}][waktu_kegiatan]" id="waktu_kegiatan_${kegiatanCount}"
                    ...
                    <div class="flex justify-between items-center mt-2">
                        ...
                        <input type="text" name="agenda_kegiatan[${kegiatanCount}][judul_kegiatan]" id="judul_kegiatan_${kegiatanCount}"
                            class="border-gray-300 shadow-sm w-1/2 rounded-lg" required>
                    </div>
                    <div class="flex justify-between items-center mt-2">
                        <label for="deskripsi_kegiatan_${kegiatanCount}" class="text-lg font-medium">Deskripsi Kegiatan</label>
                        <textarea name="agenda_kegiatan[${kegiatanCount}][deskripsi_kegiatan]" id="deskripsi_kegiatan_${kegiatanCount}"
