    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('video.update', $galeri->id) }}" method="post">
                    @csrf
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            <label for="nama" class="text-lg font-medium">Nama</label>
                            <input value="{{ old('nama', $galeri->nama) }}" name="nama" placeholder="Nama"
                        ...
                        <div>
                            ...
                            <input value="{{ old('tgl_galeri', $galeri->tgl_galeri) }}" name="tgl_galeri"
                        ...
                        <div>
                            ...
                            <input value="{{ old('url_video', $galeri->url_video) }}" name="url_video"
                        ...
                        <div>
                            ...
                            <input value="{{ old('deskripsi', $galeri->deskripsi) }}" name="deskripsi"
                                placeholder="Deskripsi Video" type="text"
                                class="border-gray-300 shadow-sm w-full rounded-lg p-2">
                            @error('deskripsi')
                                <p class="text-red-400 font-medium">{{ $message }}</p>
                            @enderror
